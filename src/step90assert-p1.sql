...
BEGIN
    ...
    ASSERT (SELECT osmc.hBig_to_afa_log(37996971798872115))      = 'BR-SP-SaoPaulo~MDUGD', '4.3. hBig -> log';
    ASSERT (SELECT osmc.afa_log_to_hBig('BR-SP-SaoPaulo~MDUGD')) = '37996971798872115',    '4.4. log -> hBig';
END;

...
('BR-RJ-RioJaneiro',952019,76,'{0EACM,0EADM,0EAFK,0EAEK,0EAFJ,0EADL,0EAF4T,0EAF4S,0EAF4P,0EAF4N,0EADET,0EADES,0EAF4Z,0EAF4V,0EAF4R,0EAF4Q,0EADEZ,0EADEV,0EAF5S,0EAF5P,0EAF5N,0EADFT,0EADFS}'::text[]),
...
('CO-AMA-Leticia',9377,170,'{1D35J,1D35L,1D1EK,1D1EL,1D1EM,1D2H,1D31K,1D31L,1D31M,1D32M,1D33J,1D33K,1D33L,1D33M,1D34J,1D34K,1D34L,1D34M,1D36J,1D36K,1D36L,1D36M,1D37J,1D37L,1D3H,1D8G,1D9G,1D9H,1DCH}'::text[]),
